package com.company.capi.swagger;

import com.company.capi.swagger.ApiPathProvider;
...
public class SwaggerConfig {
    ...
    public static final List<String> DEFAULT_INCLUDE_PATTERNS = Arrays.asList("/customer/.*");
    public static final String SWAGGER_GROUP = "customer-api";
